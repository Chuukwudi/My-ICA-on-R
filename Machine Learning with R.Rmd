...
Now, let us encode the columns with ordinal variables.

```{r}
dataset$CompanySize <- data.matrix(dataset$CompanySize)
dataset$YearsCoding <- data.matrix(dataset$YearsCoding)
dataset$YearsCodingProf <- data.matrix(dataset$YearsCodingProf)
dataset$NumberMonitors <- data.matrix(dataset$NumberMonitors)
View(dataset)
